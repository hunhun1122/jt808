...
public class MsgDecoder {
	...
	//	String  weidu=this.parseBcdStringFromBytes(data, 8, 4);		
		//float x = Integer.parseInt(weidu,16);
		ret.setLatitude(this.parseIntFromBytes(data, 8, 4)/1000000);  //parseFloatFromBytes  改动的
		// 4. byte[12-15] 经度(DWORD(32)) 以度为单位的经度值乘以10^6，精确到百万分之一度
		ret.setLongitude(this.parseIntFromBytes(data, 12, 4)/1000000);
		//ret.setLongitude(y);
